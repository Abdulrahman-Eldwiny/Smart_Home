...
# 325 "./mcc_generated_files/pin_manager.h"
...
# 188 "./mcc_generated_files/tmr3.h"
uint16_t TMR3_ReadTimer(void);
# 214 "./mcc_generated_files/tmr3.h"
void TMR3_WriteTimer(uint16_t timerVal);
# 246 "./mcc_generated_files/tmr3.h"
void TMR3_Reload(void);
# 262 "./mcc_generated_files/tmr3.h"
void TMR3_ISR(void);
# 281 "./mcc_generated_files/tmr3.h"
 void TMR3_SetInterruptHandler(void (* InterruptHandler)(void));
# 299 "./mcc_generated_files/tmr3.h"
extern void (*TMR3_InterruptHandler)(void);
# 317 "./mcc_generated_files/tmr3.h"
...
void main(void)
{
    ...
    while (1)
    {
        ...
        if(readed_value=='A'){
           ...
           if(window1_state== 0 || window2_state== 0){
                if(window1_state== 0 ){
